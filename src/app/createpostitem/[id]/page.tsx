...
export default function EditPostItem({params}:{params:{id:string}}) {
  ...
  const handleFormSubmit = async(e : React.FormEvent<HTMLFormElement>)=>{e.preventDefault();
                                ...
                                <div className="row">
                                    ...
                                    <div className="mb-3">
                                        {text.validate === 'loading' && (
                                            <div className="loading">Updating Post
                                            </div>
                                        )}
                                        {text.validate === 'incomplete' && (
                                            <div className="error-message">Please fill in all above details.
                                            </div>
                                        )}
                                        {text.validate === 'success' && (
                                            <div className="sent-message">Your news was posted succesfull. Thank You!
                                            </div>
                                        )}
                                        {text.validate === 'error' && (
